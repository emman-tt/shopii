  ...
  return (
    ...
    >
      <section className='max-[500px]:overflow-y-scroll [scrollbar-width:none]  h-full'>
        ...
        <button onClick={() => {setIsActive(false)}} className='w-[90%] mt-3 py-2 flex justify-center items-center align-bottom ml-6 max-[800px]:mt-1 max-[800px]:py-1 bg-black text-white max-[1040px]:ml-2 max-[500px]:mt-6'>
          Save
        </button>
      </section>
    </section>
