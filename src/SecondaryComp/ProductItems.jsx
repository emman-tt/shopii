      ...
      {items.length < 1 ? (
        ...
        <>
          {items.map(item => (
            <section
              key={item.id}
              className='w-[23%] max-[1040px]:w-[29%] max-[800px]:w-[45%] h-80 max-[800px]:h-60 flex flex-col max-[500px]:w-[46%] max-[500px]:h-50'
            >
              ...
              <section className='flex w-full max-[500px]:px-0 px-2 items-center h-[5%] justify-between text-[13px] max-[800px]:text-[11px] pt-5 max-[500px]:text-[10px] max-[500px]:mt-4'>
                ...
                <div className='max-[500px]:w-[40%] max-[500px]:text-end'>{item.price} $</div>
              </section>
            </section>
          ))}
        </>
