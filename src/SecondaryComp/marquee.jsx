...
export default function Marquee () {
  ...
  return (
    <section className='bg-black h-max py-30 sm:mt-60 pt-60 overflow-hidden flex flex-col gap-10 relative w-full'>
      {/* right shadow */}
      <div className='absolute h-full w-[15%] max-sm:w-[0%] bg-[#050101] right-0   bottom-0 z-5 shadow-[-150px_20px_120px_-5px_rgba(0,0,0,0.3)] max-sm:shadow-[0px_0px_90px_90px_rgba(0,0,0,0.3)] shadow-black top-[10%] max-sm:top-[40%] '></div>

      {/* left shadow */}

      <div className='absolute h-full w-[15%] max-sm:w-[4%] bg-[#050101] left-0   bottom-0 z-5 shadow-[150px_20px_120px_-5px_rgba(0,0,0,0.3)] shadow-black max-sm:shadow-[0px_0px_90px_90px_rgba(0,0,0,0.3)] top-[10%]  max-sm:pb-10'></div>
